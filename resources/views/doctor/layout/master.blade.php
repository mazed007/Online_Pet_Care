<html>
 ...
 <!--  <a class="navbar-brand" href="#">Navbar</a>-->
  ...
  <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{route('doctor.docPetInfo')}}">Pet Information</a>
      </li>
     ...
     @if (Auth::guest())
                            <a href="{{ url('/doctor/login') }}">Login</a> &nbsp &nbsp &nbsp &nbsp
                            <a href="{{ url('/doctor/register') }}">Register</a>
                        @else
                            <li class="dropdown">
